    ...
    return (
        <>
            ...
            <nav className={`fixed top-0 left-0 w-full z-50 py-4 px-4 md:px-8 lg:px-18 flex justify-between items-center transition-all duration-300 ${isScrolled ? "bg-white shadow-sm" : "bg-transparent"}`}>
                ...
                {/* Desktop Navigation */}
                <div className="hidden lg:flex items-center flex-wrap justify-center gap-x-3 font-semibold overpass text-gray-800">
                    {[
                        "Home",
                        "Services",
                        "Products",
                        ...
                        <React.Fragment key={item}>
                            {item === "Services" ? (
                                // 🔹 Services Dropdown
                                <div className="relative services-menu group inline-flex items-center">
                                    <button
                                    ...
                                    <div
                                        ...
                                        className={`absolute top-full mt-6.5 w-[850px] bg-[#FFF8E7] rounded-md shadow-xl flex transition-all -translate-x-1/6 duration-300 ${isServicesOpen
                                    ...
                                    >
                                        ...
                                        <div className="w-2/3 grid grid-cols-2 gap-5 p-6">
                                            {hoveredService ? (
                                                hoveredService.details.map((d, idx) => (
                                                    <div key={idx}>
                                ...
                                // 🔹 Regular Links (icon except Home)
                                <Link
                                    to="/"
                                    className="hover:text-[#0062FF] transition-colors flex items-center gap-1"
                                >
                                    {item}
                                    {item !== "Home" && <MdKeyboardArrowDown />} {/* ✅ Icon except Home */}
                                </Link>
                            )}
