...
const Navbar = () => {
    return (
        <div>
            <nav className='flex justify-between items-center py-8 px-18 fixed top-0 left-0 w-full z-50 transition-all duration-300'>
                {/* logo */}
                <div>
                    <img src={logo} alt="" />
                </div>
                {/* navigation */}
                <div>
                    <ul className='gap-3 flex font-semibold'>
                        <Link>Home </Link>/            
                ...
                <div className='flex gap-5 justify-center items-center'>
                    <div>
                        <button class="btn  relative inline-flex  items-center justify-center rounded-xl overflow-hidden font-medium transition-all bg-black gap-2 group py-2.5 px-5">
